...
```bash
source civicos-env/bin/activate && pytest packages/civicos/tests/test_civicos.py -q --tb=short
```
...
```bash
source civicos-env/bin/activate && pytest packages/civicos/tests/ -q
```
...
```bash
source civicos-env/bin/activate && pytest packages/civicos/tests/ -q --durations=20
```
