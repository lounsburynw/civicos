...
## Post-Pilot Revenue Considerations

*Added: Session 210 (December 2025)*

### The Nuance We Should Acknowledge

The sections above argue (correctly) that **coordination infrastructure** cannot be monetized without mission compromise. However, in building that infrastructure, we've created adjacent capabilities that *could* generate revenue without compromising the core mission.

**The distinction:**

| Layer | Must Be Free | Could Be Monetized |
|-------|--------------|-------------------|
| **Coordination** | Resident discovery, coalition building, campaign routing | ❌ Never - this is the public good |
| **Intelligence** | Meeting search, legislative context, outcome tracking | ⚠️ Maybe - adjacent service |

### The Specific Opportunity: Transcript Search

We've built semantic search over meeting transcripts (RAG) as infrastructure for coordination. This same capability has standalone value:
...
**For city staff (paid tier, ~$100/month):**
- Same search capabilities
- Bulk export for public records requests
- Priority transcription of new meetings
- Admin dashboard

**Why this doesn't compromise mission:**
1. Residents get full access for free (coordination layer untouched)
2. Cities paying for operational efficiency, not influence
3. Interests are aligned (both want accessible meeting records)
4. If a competitor builds this, we use theirs and focus on coordination

### Strategic Framing

**For foundations:** "We're exploring earned revenue for operational sustainability. The core coordination infrastructure remains free and foundation-supported. Transcript search is adjacent infrastructure that cities may value independently."

**For ourselves:** This is a hedge, not a pivot. If it works, we have runway. If competitors emerge, we've validated the need and can use their solution. Either way, we're not distracted from coordination.

### Decision Timeline

| Phase | Revenue Consideration |
|-------|----------------------|
| **Jan 2026 pilot** | Focus on coordination validation only. No revenue exploration. |
| **Feb 2026 analysis** | Note qualitative signal: Did residents/staff find transcript search useful? |
| **Mar 2026+ (if pilot succeeds)** | Consider pilot with 1-2 cities for paid tier. Separate from coordination work. |
| **If pilot fails** | Transcript search becomes potential fallback product (graceful degradation). |

### What This Is NOT

- ❌ A revenue model for coordination (still foundation-funded)
- ❌ A pivot toward B2G SaaS (still mission-driven)
- ❌ A reason to deprioritize foundation relationships (still primary funding path)

### What This IS

- ✅ Acknowledging that sustainability matters to foundations
- ✅ Distinguishing between "must be free" and "could generate revenue"
- ✅ Leaving the door open without committing resources
- ✅ A fallback if coordination hypothesis fails

**Bottom line:** Foundation funding remains the primary path. Revenue from transcript search is a post-pilot consideration that could strengthen (not replace) that path.
...
- `docs/critical/PILOT_ROADMAP.md` - Jan 2026 pilot plan
...
6. Submit proposals (Q2 2026)

**Timeline**:
- Jan 2026: Run pilot (4 weeks)
- Feb 2026: Analyze results, document case study
- Mar 2026: Draft foundation pitch deck, refine pitch
- Apr-May 2026: Submit proposals (Knight Foundation, SF Foundation, etc.)
- Jun-Aug 2026: Follow-up, site visits, revisions
- Sep-Dec 2026: First foundation grant secured ($50-100K)
