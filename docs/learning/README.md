...
**NotebookLM:** Upload all four as sources. Ask it to generate an audio overview, or quiz you on specific topics.

**Claude.ai:** Paste a module into a conversation and ask follow-up questions. The "Questions to Explore" sections in Modules 3 and 4 have good starting prompts.

**Reading order:** 1 → 2 → 3 → 4. Each builds on the previous. Module 3 ties the system together. Module 4 stress-tests it against adversaries.
