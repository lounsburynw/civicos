...
- `docs/core/next_session_prompt.md` - Session 119 priorities
- `docs/architecture/COORDINATION_ORCHESTRATION_ARCHITECTURE.md` - LangGraph workflows
- `docs/architecture/CITY_STATE_MODEL.md` - StateManager design
