...
1. Start the frontend: `cd apps/civicos-workspace && npm run dev`
...
✅ Frontend (`apps/civicos-workspace/src/services/api.ts`):
- Line 181: `archetypes` parameter in API interface

✅ Frontend (`apps/civicos-workspace/src/components/workspace/CommentDraftArtifact.vue`):
