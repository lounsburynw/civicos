...
class GoogleCivicClient:
    ...
    def __init__(
        ...
        Args:
            ...
            api_key: Google API key with Civic Information API enabled.
                     Falls back to GOOGLE_CIVICOS_API_KEY or GOOGLE_API_KEY env vars.
        """
        self.jurisdiction_id = jurisdiction_id
        self.api_key = (
            api_key
            or os.environ.get("GOOGLE_CIVICOS_API_KEY")
    ...
    def health(self) -> HealthStatus:
        ...
        if not self.api_key:
            errors.append("No API key configured (GOOGLE_CIVICOS_API_KEY or GOOGLE_API_KEY)")
            return HealthStatus(
    ...
    def validate(self) -> ValidationResult:
        ...
        if not self.api_key:
            errors.append(
                "No API key configured. Set GOOGLE_CIVICOS_API_KEY or GOOGLE_API_KEY env var."
            )
            config_valid = False
