...
def add_research_parser(subparsers: argparse._SubParsersAction) -> None:
    ...
    funding_parser.add_argument(
        "--provider",
        default=None,
        help="Search provider to use (default: from CIVICOS_SEARCH_PROVIDER env var)",
    )
...
def run_municipal_funding(args: argparse.Namespace) -> int:
    ...
    try:
        from civicos_extraction.research import MunicipalFundingResearcher
        from civicos_extraction.research.providers import get_provider
