...
from civicos_extraction.cli.agenda import add_agenda_parser, run_agenda
...
from civicos_extraction.cli.legislative import add_legislative_parser, run_legislative
...
from civicos_extraction.cli.transcribe import (
    add_transcribe_parser,
    run_transcribe,
    add_validate_transcripts_parser,
    run_validate_transcripts,
)
from civicos_extraction.cli.uscode import add_uscode_parser, run_uscode
from civicos_extraction.cli.vectors import add_vectors_parser, run_vectors
from civicos_extraction.cli.youtube import add_youtube_parser, run_youtube
from civicos_extraction.cli.youtube_boards import add_youtube_boards_parser, run_youtube_boards
...
def main() -> int:
    ...
    add_validate_transcripts_parser(subparsers)
    ...
    elif args.command == "validate-transcripts":
        return run_validate_transcripts(args)
