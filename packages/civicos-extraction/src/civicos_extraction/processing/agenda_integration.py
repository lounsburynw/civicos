...
class AgendaIntegrator:
    ...
    def __init__(
        ...
        # CLI entry points (in civic_extraction/cli/) get provider from civicos_services
        if provider is not None:
            ...
            raise ValueError(
                ...
                "where get_model_for_task is imported from civicos_services.core.llm_provider"
            )
