...
from civicos_extraction.clients.google_civic import GoogleCivicClient, create_san_rafael_civic_client
...
class TestGoogleCivicClient:
    ...
    def test_client_env_api_key(self, monkeypatch):
        ...
        monkeypatch.setenv("GOOGLE_CIVICOS_API_KEY", "env-key")
    ...
    def test_client_falls_back_to_google_api_key(self, monkeypatch):
        ...
        monkeypatch.delenv("GOOGLE_CIVICOS_API_KEY", raising=False)
...
class TestGoogleCivicMappers:
    ...
    def test_infer_election_type_primary(self):
        ...
        from civicos_extraction.clients.google_civic import _infer_election_type
    ...
    def test_google_civic_to_election_normalized(self):
        ...
        from civicos_extraction.clients.google_civic import google_civic_to_election
    ...
    def test_google_civic_to_voter_info(self):
        ...
        from datetime import date
        from civicos_extraction.clients.google_civic import google_civic_to_voter_info
