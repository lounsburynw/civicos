...
class TestSuggestionWorkflow:
    ...
    def test_suggestion_workflow_runs(self):
        ...
        from civicos._internal.coordination import run_suggestion_workflow
        with tempfile.TemporaryDirectory() as tmpdir:
            db_path = os.path.join(tmpdir, "test.db")
    ...
    def test_suggestion_workflow_with_data(self):
        ...
        from civicos._internal.coordination import SuggestionApp
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            civic = CivicOS("san-rafael", db_path=db_path)
    ...
    def test_create_suggestion_workflow(self):
        ...
        from civicos._internal.coordination import create_suggestion_workflow
...
class TestPreparationWorkflow:
    ...
    def test_preparation_workflow_runs(self):
        ...
        from civicos._internal.coordination import run_preparation_workflow
        with tempfile.TemporaryDirectory() as tmpdir:
            db_path = os.path.join(tmpdir, "test.db")
    ...
    def test_preparation_app_class(self):
        ...
        from civicos._internal.coordination import PreparationApp
    ...
    def test_create_preparation_workflow(self):
        ...
        from civicos._internal.coordination import create_preparation_workflow
...
class TestPatternLearnerWorkflow:
    ...
    def test_pattern_learner_class_creation(self):
        ...
        from civicos._internal.coordination import PatternLearner
    ...
    def test_get_success_patterns(self):
        ...
        from civicos._internal.coordination import PatternLearner, get_success_patterns
        from civicos import CivicOS
    ...
    def test_pattern_data_class(self):
        ...
        from civicos._internal.coordination import Pattern
    ...
    def test_strategy_data_class(self):
        ...
        from civicos._internal.coordination import Strategy
    ...
    def test_create_learning_workflow(self):
        ...
        from civicos._internal.coordination import create_learning_workflow
    ...
    def test_create_strategy_workflow(self):
        ...
        from civicos._internal.coordination import create_strategy_workflow
...
class TestStrategySuggestionsWorkflow:
    ...
    def test_strategy_suggester_class_creation(self):
        ...
        from civicos._internal.coordination import StrategySuggester
    ...
    def test_run_strategy_suggestions_function(self):
        ...
        from civicos._internal.coordination import run_strategy_suggestions
        from civicos import CivicOS
    ...
    def test_strategy_suggestion_data_class(self):
        ...
        from civicos._internal.coordination import StrategySuggestion
    ...
    def test_pattern_analysis_data_class(self):
        ...
        from civicos._internal.coordination import PatternAnalysis
    ...
    def test_create_strategy_suggestions_workflow(self):
        ...
        from civicos._internal.coordination import create_strategy_suggestions_workflow
