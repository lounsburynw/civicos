...
Plans collective action using civicos-coordination LangGraph workflows.
"""
...
# Optional civicos-coordination import
try:
...
def coordinate_action(
    ...
    Raises:
        ImportError: If civicos-coordination not installed
