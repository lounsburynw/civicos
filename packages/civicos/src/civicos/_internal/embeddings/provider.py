    ...
    def __init__(self, model_name: Optional[str] = None):
        ...
        Args:
            model_name: SentenceTransformer model name.
                       Defaults to CIVICOS_EMBEDDING_MODEL env var or 'nomic-ai/nomic-embed-text-v1.5'
        """
        try:
        ...
        self._model_name = model_name or os.environ.get(
            "CIVICOS_EMBEDDING_MODEL", self.DEFAULT_MODEL
        )
    ...
    def __init__(
        ...
        Args:
            model_name: OpenAI embedding model name.
                       Defaults to CIVICOS_EMBEDDING_MODEL env var or 'text-embedding-3-small'
    ...
    **kwargs,
    ...
    Args:
        provider_type: Provider to use:
                      ...
                      Defaults to CIVICOS_EMBEDDING_PROVIDER env var or 'fastembed'.
        model_name: Model name override. Defaults to CIVICOS_EMBEDDING_MODEL env var.
    ...
    provider_type = provider_type or os.environ.get(
        "CIVICOS_EMBEDDING_PROVIDER", "fastembed"
    )
