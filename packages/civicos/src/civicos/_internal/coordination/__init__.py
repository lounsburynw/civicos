"""
civicos-coordination: LangGraph coordination workflows for civic campaigns
...
from civicos._internal.coordination.state import CoordinationState, merge_actors
from civicos._internal.coordination.nodes import (
    detect_decision,
    discover_residents,
    should_discover,
    DEFAULT_DB_PATH,
)
from civicos._internal.coordination.graph import (
    CoordinationApp,
...
from civicos._internal.coordination.suggestion_state import SuggestionState
from civicos._internal.coordination.suggestion_nodes import (
    gather_context,
    generate_candidates,
    rank_suggestions,
    filter_suggestions,
...
from civicos._internal.coordination.suggestion_graph import (
    SuggestionApp,
...
from civicos._internal.coordination.preparation_state import PreparationState
from civicos._internal.coordination.preparation_nodes import (
    load_agenda_item,
...
from civicos._internal.coordination.preparation_graph import (
    PreparationApp,
...
from civicos._internal.coordination.pattern_state import PatternState, Pattern, Strategy
...
from civicos._internal.coordination.pattern_graph import (
    PatternLearner,
...
from civicos._internal.coordination.strategy_state import (
    StrategyState,
    StrategySuggestion,
    PatternAnalysis,
)
from civicos._internal.coordination.strategy_nodes import (
...
from civicos._internal.coordination.strategy_graph import (
    StrategySuggester,
