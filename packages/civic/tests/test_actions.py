...
class TestSubscriptionsModule:
    ...
    def test_follow_item_import(self):
        ...
        from civic.actions.subscriptions import follow_item, Subscription
    ...
    def test_unfollow_item(self):
        ...
        from civic.actions.subscriptions import follow_item, unfollow_item
        from civic._internal.state import StateManager
    ...
    def test_unfollow_nonexistent(self):
        ...
        from civic.actions.subscriptions import unfollow_item
...
class TestPreparationModule:
    ...
    def test_prepare_extracts_topic_from_title(self):
        ...
        from civic.actions.preparation import _extract_topic_from_item
