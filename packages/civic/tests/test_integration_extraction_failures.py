...
class TestCachedDataFallback:
    ...
    def civic_client(self, temp_db):
        ...
        return Civic("city-san-rafael", db_path=temp_db)
    ...
    def test_civic_whats_next_uses_cached_data(self, temp_db):
        ...
        c = Civic("city-san-rafael", db_path=temp_db)
    ...
    def test_multiple_jurisdictions_cached_independently(self, temp_db):
        ...
        sr_client = Civic("city-san-rafael", db_path=temp_db)
        berkeley_client = Civic("city-berkeley", db_path=temp_db)
