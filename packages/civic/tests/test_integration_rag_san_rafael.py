...
class TestAgendaPacketParser:
    ...
    def test_parser_imports(self):
        ...
        from civic._internal.meetings import AgendaPacketParser, AgendaChunk
    ...
    def test_parser_sections(self):
        ...
        from civic._internal.meetings import AgendaPacketParser
...
class TestStaffReportExtractor:
    ...
    def test_extractor_imports(self):
        ...
        from civic._internal.meetings import StaffReportExtractor, StaffReportMetadata
    ...
    def test_extractor_from_chunks(self):
        ...
        from civic._internal.meetings import StaffReportExtractor
    ...
    def test_metadata_to_dict(self):
        ...
        from civic._internal.meetings import StaffReportMetadata
...
class TestOrdinanceExtractor:
    ...
    def test_extractor_imports(self):
        """Validate extractor module can be imported."""
        from civic._internal.meetings.ordinance import OrdinanceExtractor, OrdinanceMetadata
    ...
    def test_find_ordinances(self):
        ...
        from civic._internal.meetings.ordinance import OrdinanceExtractor
    ...
    def test_metadata_to_dict(self):
        ...
        from civic._internal.meetings.ordinance import OrdinanceMetadata, OrdinanceSection
    ...
    def test_extract_shelter_ordinances_function(self):
        ...
        from civic._internal.meetings.ordinance import extract_shelter_ordinances
...
class TestMinutesExtractor:
    ...
    def test_extractor_imports(self):
        ...
        from civic._internal.meetings import MinutesExtractor, MeetingMinutes
    ...
    def test_extractor_creates_instance(self):
        ...
        from civic._internal.meetings import MinutesExtractor
    ...
    def test_convenience_function(self):
        ...
        pytest.importorskip("fitz", reason="PyMuPDF required for extraction")
        from civic._internal.meetings import extract_meeting_minutes
...
class TestDecisionExtractor:
    ...
    def test_extractor_imports(self):
        ...
        from civic._internal.meetings import DecisionExtractor, Decision
        assert DecisionExtractor is not None
        assert Decision is not None

    def test_extractor_creates_instance(self):
        """Validate DecisionExtractor can be instantiated."""
        from civic._internal.meetings import DecisionExtractor
    ...
    def test_vote_tally_properties(self):
        ...
        from civic._internal.meetings.decision import VoteTally
    ...
    def test_convenience_function(self):
        ...
        from civic._internal.meetings import extract_decisions
...
class TestEmbeddingGeneration:
    ...
    def test_embeddings_imports(self):
        ...
        from civic._internal.meetings import (
            MerrydaleEmbeddings,
            SearchResult,
    ...
    def test_convenience_build_function(self):
        ...
        from civic._internal.meetings import build_merrydale_index
...
class TestVectorIndexCreation:
    ...
    def test_index_can_be_reloaded(self):
        ...
        from civic._internal.meetings import CivicEmbeddings
...
class TestSearchDecisions:
    ...
    def test_search_returns_results(self):
        ...
        from civic._internal.meetings import SearchResult
...
class TestConvenienceSearchFunction:
    ...
    def test_search_merrydale_decisions(self):
        ...
        from civic._internal.meetings import search_merrydale
...
class TestWhatWasSaidTranscripts:
    ...
    def test_what_was_said_returns_excerpts(self, build_transcript_index):
        ...
        from civic import Civic, TranscriptExcerpt
    ...
    def test_what_was_said_no_transcripts(self):
        ...
        c = Civic("nonexistent-jurisdiction")
