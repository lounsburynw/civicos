...
class TestTranscriptUtterance:
    ...
    def test_utterance_creation(self):
        ...
        from civic._internal.meetings.transcript import TranscriptUtterance
...
class TestTranscriptChunk:
    ...
    def test_chunk_creation(self):
        ...
        from civic._internal.meetings.transcript import TranscriptChunk
...
class TestTranscriptChunkerBasic:
    ...
    def test_chunk_single_utterance(self):
        ...
        from civic._internal.meetings.transcript import TranscriptChunker, TranscriptUtterance
...
class TestConvenienceFunction:
    ...
    def test_chunk_transcript_function(self):
        ...
        from civic._internal.meetings.transcript import chunk_transcript
...
class TestSpeakerInfo:
    ...
    def test_speaker_info_creation(self):
        ...
        from civic._internal.meetings.transcript import SpeakerInfo
...
class TestSpeakerRoleDetector:
    ...
    def test_detector_initialization(self):
        ...
        from civic._internal.meetings.transcript import SpeakerRoleDetector
    ...
    def test_detect_roll_call_council_members(self):
        ...
        from civic._internal.meetings.transcript import SpeakerRoleDetector, TranscriptUtterance
...
class TestPublicCommentWithRealData:
    ...
    def test_real_transcript_public_comment_detection(self):
        ...
        from pathlib import Path
        from civic._internal.meetings.transcript import SpeakerRoleDetector, TranscriptChunker
