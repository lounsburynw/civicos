...
class TestGetEmbeddingProvider:
    ...
    def test_env_var_local(self):
        """CIVIC_EMBEDDING_PROVIDER=local returns SentenceTransformerProvider."""
        with patch.dict(os.environ, {"CIVIC_EMBEDDING_PROVIDER": "local"}):
            provider = get_embedding_provider()
            assert isinstance(provider, SentenceTransformerProvider)

    def test_env_var_openai(self):
        """CIVIC_EMBEDDING_PROVIDER=openai returns OpenAIProvider."""
