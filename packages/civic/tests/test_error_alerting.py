...
class TestErrorMetricsCollector:
    ...
    def test_calculate_metrics_no_log_file(self, tmp_path):
        ...
        from civic_services.monitoring.error_alerting import ErrorMetricsCollector
...
class TestErrorAlertManager:
    ...
    def test_init_reads_environment_variables(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("CIVIC_ALERT_EMAILS", "test@example.com, admin@example.com")
        monkeypatch.setenv("CIVIC_SMTP_SERVER", "smtp.test.com")
        monkeypatch.setenv("CIVIC_SMTP_PORT", "465")
        monkeypatch.setenv("CIVIC_SLACK_WEBHOOK_URL", "https://hooks.slack.com/test")
    ...
    def test_check_and_alert_insufficient_requests(self, tmp_path, monkeypatch):
        ...
        # Clean environment
        monkeypatch.delenv("CIVIC_ALERT_EMAILS", raising=False)
        monkeypatch.delenv("CIVIC_SLACK_WEBHOOK_URL", raising=False)
...
class TestSlackAlertChannel:
    ...
    def test_send_slack_alert_not_configured(self, tmp_path, monkeypatch):
        ...
        from civic_services.monitoring.error_alerting import ErrorAlertManager, AlertEvent, ErrorMetrics
...
class TestMultiChannelAlerting:
    ...
    def test_both_channels_configured(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("CIVIC_ALERT_EMAILS", "test@example.com")
        monkeypatch.setenv("CIVIC_SMTP_USERNAME", "user@test.com")
        monkeypatch.setenv("CIVIC_SMTP_PASSWORD", "password")
        monkeypatch.setenv("CIVIC_SLACK_WEBHOOK_URL", "https://hooks.slack.com/test")
    ...
    def test_slack_only_when_email_not_configured(self, tmp_path, monkeypatch):
        ...
        monkeypatch.delenv("CIVIC_ALERT_EMAILS", raising=False)
        monkeypatch.delenv("CIVIC_SMTP_USERNAME", raising=False)
        monkeypatch.setenv("CIVIC_SLACK_WEBHOOK_URL", "https://hooks.slack.com/test")
