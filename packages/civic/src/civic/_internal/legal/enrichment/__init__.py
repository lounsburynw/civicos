...
Usage:
    from civic._internal.legal.enrichment import enrich_opportunity, LegislativeCache
...
try:
    from civic._internal.legal.enrichment.semantic import SemanticEnricher
