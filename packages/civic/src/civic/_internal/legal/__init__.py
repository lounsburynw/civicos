"""
civic-legal: Legal RAG system for civic data
...
Usage:
    # Corpus fetching
    from civic._internal.legal.corpus import CaliforniaCorpus
...
from civic._internal.legal.corpus import CaliforniaCorpus, FederalCorpus

# Enrichment - backwards compatible with civic-enrichment
from civic._internal.legal.enrichment import (
    LegislativeCache,
...
try:
    from civic._internal.legal.retrieval import LegalSearch, Reranker, ContextBuilder
...
try:
    from civic._internal.legal.mcp import create_mcp_server, LegalServer
    MCP_AVAILABLE = True
except ImportError:
    MCP_AVAILABLE = False
