...
class ErrorAlertManager:
    ...
    def __init__(
        ...
        self.alert_emails = os.environ.get('CIVICOS_ALERT_EMAILS', '').split(',')
        self.alert_emails = [e.strip() for e in self.alert_emails if e.strip()]
        self.smtp_server = os.environ.get('CIVICOS_SMTP_SERVER', 'smtp.gmail.com')
        self.smtp_port = int(os.environ.get('CIVICOS_SMTP_PORT', '587'))
...
if __name__ == "__main__":
    ...
    if "--check" in sys.argv:
        ...
        print("  CIVICOS_ALERT_EMAILS    - Comma-separated list of email addresses")
        print("  CIVICOS_SMTP_SERVER     - SMTP server (default: smtp.gmail.com)")
        print("  CIVICOS_SMTP_PORT       - SMTP port (default: 587)")
